...
function makeMarketUpdateInstructions(
    ...
    if (moveOrders) {
        ...
        console.log(
            `${marketContext.marketName} Requoting sentBidPx: ${marketContext.sentBidPrice
            } newBidPx: ${bookAdjBid} sentAskPx: ${marketContext.sentAskPrice
            } newAskPx: ${bookAdjAsk} aggBid: ${aggBid} addAsk: ${aggAsk}`,
        );
